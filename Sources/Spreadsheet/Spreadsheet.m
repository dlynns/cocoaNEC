...
- (Boolean)editFormula:(NSString*)str title:(NSString*)title
{
    ...
    NSString *convertedString = [ self interpretSpreadsheetCell:str conversion:conversionNormal ];
	[ formulaBar setStringValue:convertedString ] ;
    NSLog(@"setting editing bar to string=%@", str);
    NSLog(@"setting editing bar to string=%@", convertedString);
...
- (void)textDidEndEditing:(NSNotification*)notification
{
	...
	if ( selectedColumn != nil ) {
        ...
        editedString = [ self interpretSpreadsheetCell:editedString conversion:conversionMETRIC ];

        NSLog(@"editedString=%@", editedString);
